...
var WEB_PORT = exports.WEB_PORT = process.env.PORT || 5000;
...
var API_BASE_URL = exports.API_BASE_URL = process.env.NODE_ENV === 'production' ? 'http://localhost:' + WEB_PORT : 'https://localhost:' + WEB_PORT; // required for heroku
